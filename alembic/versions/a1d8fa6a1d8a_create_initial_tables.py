...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_experience_levels_id"), "experience_levels", ["id"], unique=False
    )
    op.create_table(
        "genres",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index(op.f("ix_orientations_id"), "orientations", ["id"], unique=False)
    op.create_table(
        "positions",
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=False),
    ...
    op.create_index(
        op.f("ix_recruitment_types_id"), "recruitment_types", ["id"], unique=False
    )
    op.create_table(
        "regions",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "login_type",
            postgresql.ENUM("email", "social", name="login_type_enum"),
            nullable=False,
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "band_composition", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "application_method", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_recruiting_posts_id"), "recruiting_posts", ["id"], unique=False
    )
    op.create_table(
        "refresh_tokens",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "provider",
            postgresql.ENUM(
                "google", "naver", "kakao", "apple", name="social_provider_enum"
            ),
            nullable=False,
        ),
        sa.Column(
            "provider_id", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False
        ),
        sa.Column("email", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True),
    ...
    op.create_index(
        op.f("ix_user_bookmarks_id"), "user_bookmarks", ["id"], unique=False
    )
    op.create_table(
        "comments",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_post_bookmarks_id"), "post_bookmarks", ["id"], unique=False
    )
    op.create_table(
        "profile_genres",
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_recruiting_posts_id"), table_name="recruiting_posts")
    ...
    op.drop_index(op.f("ix_experience_levels_id"), table_name="experience_levels")

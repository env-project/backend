...
# 이미지 업로드
app.include_router(image_upload_router, prefix="/api/v1/common/uploads/images", tags=["Image Upload"])

# 마스터 데이터
app.include_router(master_data_router, prefix="/api/v1/common/master-data", tags=["Master Data"])
